        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                    LastName = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: false),
                    Id_Dep = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearPress = table.Column<int>(type: "integer", nullable: false),
                    Id_Themes = table.Column<int>(type: "integer", nullable: false),
                    Id_Category = table.Column<int>(type: "integer", nullable: false),
                    Id_Author = table.Column<int>(type: "integer", nullable: false),
                    Id_Press = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Lib = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
